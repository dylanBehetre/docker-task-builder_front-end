module.exports = function(RED) {
	...
	function EncodageNode(config) {
		...
		/*Traitement souhaite*/
		this.log("Encodage fct !");
		this.status({fill:"yellow",shape:"dot",text:this.encodage});
	...
	RED.nodes.registerType("encodage", EncodageNode);
}
